...
public class ModDamageTypeTagGenerator extends TagsProvider<DamageType> {
    ...
    public static final TagKey<DamageType> WIND_MAGIC = TagKey.create(Registries.DAMAGE_TYPE,
            new ResourceLocation(WindSpellbooksMod.MOD_ID, "wind_magic"));
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        tag(WIND_MAGIC).add(ModDamageTypes.WIND_MAGIC);
    }
}