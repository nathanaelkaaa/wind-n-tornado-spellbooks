package net.raptorzizi.frierens_spellbooks.entity.armor;
...
public class AeromancerArmorModel extends DefaultedItemGeoModel<AeromancerArmorItem> {
    ...
    public AeromancerArmorModel() {
        super(ResourceLocation.fromNamespaceAndPath(FrierensSpellbooksMod.MOD_ID, ""));
    }

    @Override
    public ResourceLocation getModelResource(AeromancerArmorItem object) {
        return ResourceLocation.fromNamespaceAndPath(FrierensSpellbooksMod.MOD_ID, "geo/aeromancer_armor.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(AeromancerArmorItem object) {
        return ResourceLocation.fromNamespaceAndPath(FrierensSpellbooksMod.MOD_ID, "textures/models/armor/aeromancer.png");
    }
