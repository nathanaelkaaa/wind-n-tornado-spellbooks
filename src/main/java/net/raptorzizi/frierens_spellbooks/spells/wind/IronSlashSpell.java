...
import net.raptorzizi.frierens_spellbooks.spells.ModSpellAnimations;
import net.raptorzizi.frierens_spellbooks.util.ElementCheck;
...
public class IronSlashSpell extends AbstractSpell {
    ...
    private final ResourceLocation spellId =
            ResourceLocation.fromNamespaceAndPath(FrierensSpellbooksMod.MOD_ID, "iron_slash");
