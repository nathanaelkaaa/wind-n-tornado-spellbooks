...
import net.raptorzizi.frierens_spellbooks.entity.spells.almighty_push.AlmightyPushRenderer;
import net.raptorzizi.frierens_spellbooks.entity.spells.iron_slash.IronSlashRenderer;
import net.raptorzizi.frierens_spellbooks.entity.spells.iron_slash.SlashEffectRenderer;
import net.raptorzizi.frierens_spellbooks.entity.spells.tornado.TornadoRenderer;
import net.raptorzizi.frierens_spellbooks.entity.spells.wind_blade.WindBladeRenderer;
import net.raptorzizi.frierens_spellbooks.particle.FeatherParticle;
import net.raptorzizi.frierens_spellbooks.particle.TornadoGroundSmokeParticle;
import net.raptorzizi.frierens_spellbooks.particle.TornadoFireSmokeParticle;
...
@EventBusSubscriber(
        modid = FrierensSpellbooksMod.MOD_ID,
...
public class ModClientSetup {
    ...
    private static final ResourceLocation TAILWIND_TEXTURE =
            ResourceLocation.fromNamespaceAndPath("frierens_spellbooks", "textures/entity/tailwind.png");
